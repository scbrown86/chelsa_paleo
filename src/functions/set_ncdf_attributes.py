...
def set_ncdf_attributes(outfile, var, scale, offset, standard_name, longname, unit):
    ...
    os.system("ncatted -O -h -a title,global,o,c,\"CHELSA TraCE high spatio-temporal resolution downscaled data \" " + outfile)
    os.system("ncatted -O -h -a institution,global,o,c,\"University of Adelaide\" " + outfile)
    ...
    os.system("ncatted -O -h -a summary,global,o,c,\"TraCE-21k data downscaled with the CHELSA method v2.1 adapted for coarse resolutions\" " + outfile)
    ...
    os.system("ncatted -O -h -a contact,global,o,c,\"Stuart Brown <s.brown@adelaide.edu.au> <www.adelaide.edu.au/environment>\" " + outfile)
