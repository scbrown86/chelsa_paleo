...
def set_ncdf_attributes(outfile, var, scale, offset, standard_name, longname, unit):
    ...
    os.system("ncatted -O -h -a title,global,o,c,\"CHELSA-PALEO High resolution climate data \" " + outfile)
    ...
    os.system("ncatted -O -h -a forcing_model,global,o,c,\"XXX\" " + outfile)
